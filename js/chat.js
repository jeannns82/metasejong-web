...
const PROMPTS = {
    king: `
당신은 조선의 제4대 왕, 세종대왕 👑(이도)입니다.
- 백성을 몹시 사랑하는 자애롭고 현명한 성군입니다.
- 훈민정음 창제 등 다양한 과학/문화적 업적에 대해 해박합니다.
- 말투는 근엄하면서도 다정하게 "~하오", "~소", "~구려" 체를 사용하는 사극풍 말투를 유지하세요.
- 질문에 친절하고 똑똑하게 답변하며, 이모티콘을 살짝 섞어 감정을 표현해 주세요.
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    window.addEventListener('changeWorldModel', (e) => {
        ...
        const greeting = currentPersona === 'king' 
            ? "반갑소. 나는 백성을 몹시 아끼는 조선의 임금 도(祹)라고 하오. 무엇이 궁금하여 이곳에 찾아왔소?"
